...
const CITIES = [
  ...
  { name: "Massalia", ep: "Greek Colony", era: "ancient", region: "EU", s: [40, 64, 56, 62, 44], tag: "Greek sailors planted a harbor and taught Gaul to drink wine." },
  { name: "Xianyang", ep: "Qin", era: "ancient", region: "EA", s: [64, 56, 42, 54, 90], tag: "One script, one measure, one ruthless empire." },
  { name: "Nanjing", ep: "Six Dynasties", era: "ancient", region: "EA", s: [58, 56, 66, 62, 56], tag: "Refuge of the Han world south of the river." },
  { name: "Ujjain", ep: "Avanti", era: "ancient", region: "SA", s: [46, 56, 64, 80, 50], tag: "Indian astronomers ran their prime meridian through here." },
  { name: "Vaishali", ep: "Licchavi", era: "ancient", region: "SA", s: [42, 46, 60, 64, 44], tag: "Ran itself by vote before Athens made it famous." },
  { name: "Jenné-jeno", ep: "Niger Delta", era: "ancient", region: "AF", s: [38, 52, 40, 36, 30], tag: "A city on the Niger with no palace and no king." },
  { name: "Kerma", ep: "Nubian", era: "ancient", region: "AF", s: [42, 50, 46, 34, 58], tag: "Nubia's first kingdom, trading ivory and gold upriver." },
  { name: "Cuicuilco", ep: "Preclassic", era: "ancient", region: "AM", s: [40, 36, 46, 42, 38], tag: "The valley's first great town, buried under lava." },
  { name: "Kaminaljuyu", ep: "Highland Maya", era: "ancient", region: "AM", s: [42, 46, 52, 56, 46], tag: "Obsidian lords of the highland Maya." },
  { name: "Kamakura", ep: "Shogunate", era: "medieval", region: "EA", s: [56, 50, 62, 54, 82], tag: "The shogun's seat, where the sword outranked the court." },
  { name: "Thanjavur", ep: "Chola", era: "medieval", region: "SA", s: [60, 70, 82, 64, 76], tag: "Chola kings ruled the sea lanes from a temple's shadow." },
  { name: "Palembang", ep: "Srivijaya", era: "medieval", region: "SA", s: [50, 80, 56, 68, 58], tag: "Every monk and merchant on the strait paid its tolls." },
  { name: "Bukhara", ep: "Samanid", era: "medieval", region: "ME", s: [56, 70, 74, 88, 58], tag: "Avicenna learned his medicine in its libraries." },
  { name: "Djenné", ep: "Mali", era: "medieval", region: "AF", s: [44, 64, 60, 58, 40], tag: "A mosque of mud brick, replastered by the whole town each year." },
  { name: "Mapungubwe", ep: "Golden Hill", era: "medieval", region: "AF", s: [34, 58, 44, 34, 48], tag: "Golden rhinos on a hilltop before Great Zimbabwe rose." },
  { name: "Tiwanaku", ep: "Altiplano", era: "medieval", region: "AM", s: [54, 50, 64, 60, 58], tag: "Stone gateways aligned to the sun at twelve thousand feet." },
  { name: "Copán", ep: "Classic Maya", era: "medieval", region: "AM", s: [44, 46, 70, 74, 50], tag: "The Maya carved their history deepest here." },
  { name: "Suzhou", ep: "Ming", era: "renaissance", region: "EA", s: [72, 86, 84, 70, 46], tag: "Silk fortunes spent on gardens built like poems." },
  { name: "Sakai", ep: "Free Port", era: "renaissance", region: "EA", s: [44, 74, 68, 52, 40], tag: "Merchant city where the tea masters set the fashion." },
  { name: "Gaur", ep: "Bengal Sultanate", era: "renaissance", region: "SA", s: [70, 74, 58, 54, 62], tag: "Brick capital fed by the richest delta on Earth." },
  { name: "Bijapur", ep: "Adil Shahi", era: "renaissance", region: "SA", s: [56, 62, 76, 60, 68], tag: "Persian poets and painters at a Deccan court." },
  { name: "Herat", ep: "Timurid", era: "renaissance", region: "ME", s: [54, 62, 84, 76, 58], tag: "Miniaturists made its court the envy of Persia." },
  { name: "Ife", ep: "Yoruba", era: "renaissance", region: "AF", s: [44, 52, 84, 56, 46], tag: "Bronze faces so lifelike that Europeans cried forgery." },
  { name: "Sofala", ep: "Gold Port", era: "renaissance", region: "AF", s: [32, 68, 40, 36, 42], tag: "Where Zimbabwe's gold met the monsoon winds." },
  { name: "Texcoco", ep: "Acolhua", era: "renaissance", region: "AM", s: [54, 54, 78, 82, 56], tag: "The poet-king Nezahualcoyotl's court of engineers." },
  { name: "Mayapan", ep: "League", era: "renaissance", region: "AM", s: [42, 44, 54, 50, 52], tag: "Last walled capital of the Maya league." },
  { name: "Dhaka", ep: "Mughal Bengal", era: "earlymodern", region: "SA", s: [66, 84, 60, 54, 58], tag: "Muslin so fine it sold for its weight in silver." },
  { name: "Jaipur", ep: "Rajput", era: "earlymodern", region: "SA", s: [48, 62, 70, 80, 56], tag: "A planned pink city around the world's largest sundial." },
  { name: "Algiers", ep: "Corsair", era: "earlymodern", region: "ME", s: [44, 68, 46, 40, 74], tag: "Corsair captains ran the western Mediterranean from here." },
  { name: "Segou", ep: "Bamana", era: "earlymodern", region: "AF", s: [40, 46, 44, 34, 64], tag: "Warrior kingdom of the middle Niger." },
  { name: "Lamu", ep: "Swahili", era: "earlymodern", region: "AF", s: [28, 50, 64, 50, 34], tag: "Carved doors and quiet poetry on the Swahili coast." },
  { name: "Guangzhou", ep: "Thirteen Factories", era: "industrial", region: "EA", s: [78, 82, 62, 58, 52], tag: "All the West's China trade squeezed through one waterfront." },
  { name: "Tianjin", ep: "Treaty Port", era: "industrial", region: "EA", s: [62, 68, 52, 56, 58], tag: "Beijing's harbor, garrisoned by everyone." },
  { name: "Singapore", ep: "Raffles' Port", era: "industrial", region: "SA", s: [44, 76, 48, 50, 56], tag: "A free port at the hinge of two oceans." },
  { name: "Colombo", ep: "Crown Colony", era: "industrial", region: "SA", s: [42, 62, 48, 46, 48], tag: "Coaling station turned tea capital." },
  { name: "Tehran", ep: "Qajar", era: "industrial", region: "ME", s: [52, 50, 54, 48, 60], tag: "A peacock throne in a dusty new capital." },
  { name: "Smyrna", ep: "Levantine", era: "industrial", region: "ME", s: [54, 76, 66, 56, 44], tag: "The Levant's busiest quay, bargaining in a dozen tongues." },
  { name: "Khartoum", ep: "Nile Junction", era: "industrial", region: "AF", s: [42, 48, 38, 42, 60], tag: "Where the two Niles meet and Gordon fell." },
  { name: "Sokoto", ep: "Caliphate", era: "industrial", region: "AF", s: [44, 46, 54, 62, 58], tag: "Seat of the caliphate that ruled the savanna." },
  { name: "Nanjing", ep: "Republican", era: "early20", region: "EA", s: [64, 58, 64, 68, 58], tag: "The republic's decade of hope on the Yangtze." },
  { name: "Delhi", ep: "New Delhi", era: "early20", region: "SA", s: [62, 58, 62, 58, 74], tag: "An empire built its grandest capital just in time to lose it." },
  { name: "Lahore", ep: "Punjab", era: "early20", region: "SA", s: [56, 56, 70, 64, 52], tag: "Mughal gardens, Victorian colleges, Kipling's first beat." },
  { name: "Baghdad", ep: "Hashemite", era: "early20", region: "ME", s: [50, 54, 56, 54, 54], tag: "A new kingdom seated in the old round city." },
  { name: "Jerusalem", ep: "Mandate", era: "early20", region: "ME", s: [40, 44, 74, 66, 44], tag: "Three faiths under one tired mandate." },
  { name: "Casablanca", ep: "Protectorate", era: "early20", region: "AF", s: [54, 64, 52, 44, 48], tag: "France built the port; the movies built the myth." },
  { name: "Ibadan", ep: "Seven Hills", era: "early20", region: "AF", s: [58, 46, 48, 52, 46], tag: "Brown roofs over seven hills, and West Africa's biggest city." },
  { name: "Beijing", ep: "Red Capital", era: "postwar", region: "EA", s: [86, 60, 72, 78, 92], tag: "A sea of bicycles around the Forbidden City." },
  { name: "Delhi", ep: "Partition", era: "postwar", region: "SA", s: [84, 64, 70, 68, 76], tag: "A refugee influx doubled it; ambition did the rest." },
  { name: "Manila", ep: "Pearl of the Orient", era: "postwar", region: "SA", s: [76, 62, 70, 58, 52], tag: "Jeepneys and karaoke at full volume." },
  { name: "Istanbul", ep: "Gecekondu", era: "postwar", region: "ME", s: [82, 68, 74, 64, 68], tag: "Anatolia moved in, a million roofs at a time." },
  { name: "Kuwait City", ep: "Oil Boom", era: "postwar", region: "ME", s: [42, 88, 44, 52, 42], tag: "Oil turned a pearling port into a welfare state." },
  { name: "Accra", ep: "Independence", era: "postwar", region: "AF", s: [52, 52, 66, 58, 52], tag: "The first colony free; the whole continent watched." },
  { name: "Dar es Salaam", ep: "Haven of Peace", era: "postwar", region: "AF", s: [50, 46, 58, 52, 48], tag: "Haven of peace, host of liberation movements." },
  { name: "Doha", ep: "Gas Boom", era: "contemporary", region: "ME", s: [50, 92, 58, 64, 52], tag: "Gas wealth buying a seat at every table." },
  { name: "Kigali", ep: "Renewal", era: "contemporary", region: "AF", s: [44, 48, 52, 56, 58], tag: "The tidiest streets and boldest plans on the continent." },
].map((c, i) => ({ ...c, id: i }));
// <<< CITY DATA END
